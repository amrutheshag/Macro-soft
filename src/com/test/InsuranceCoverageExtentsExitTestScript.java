...
public class InsuranceCoverageExtentsExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void insurancecoverageExtentsExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Insurance Coverage Extents- Exit");
			Log.info("Executing  Insurance Coverage Extents- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Insurance Coverage Extents Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Insurance Coverage Extents Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitinsurancecoverageExtentsMultiple(driver,insurancecoverageExtentsCode);
		    		}
		    	}
			...
			public void exitinsurancecoverageExtentsMultiple(WebDriver driver,String insurancecoverageExtentsCode) throws Exception
			{
			...
			insurancecoverageExtentsPageObject.exitInsuranceCoverageExtents( insurancecoverageExtentsCode);
			...
			@AfterMethod
      		...
      		System.out.println("Done with Insurance Coverage Extents-exit  \n\n");
      		Log.info("log4j -Done with Insurance Coverage Extents-exit \n\n");
      		if (fis != null) 
      				fis.close();
      	}
      }

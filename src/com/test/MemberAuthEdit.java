...
public class MemberAuthEdit {

	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void memberAuthorizationEditTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Members Authorizations- Edit authorizations ");
	try{
			...
			int rowCount=ExcelUtils.setExcelFile(Path, "Sheet1");
		 	...
		 	String newTreatmentEndDate= ExcelUtils.getCellData(count,22);
		 	   		...
		 	   		System.out.println("----------------------------------------------------");
		   		 	System.out.println("Running Members Authorizations -Edit Auth- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("----------------------------------------------------");
	 	    		
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Members Authorizations -Edit Auth- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		 	   		editMultipleMemAuth(driver, mid, mlname, mfname, mdob, mssn,refCertNo, newTreatmentEndDate);
...
public  void editMultipleMemAuth(WebDriver driver, String mid, String mlname, String mfname, String mdob, String mssn, String refCertNo, String newTreatmentEndDate) throws Exception {
		...
		membersAuthorizationsPageObject.editMemAuth( mid, mlname, mfname, mdob, mssn, refCertNo, newTreatmentEndDate);
	
}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Member's Authorizations- Edit Authorizations");

...
public class FeeScheduleEdit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void FeeScheduleEditTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Fee Schedule- edit");
			Log.info("Executing  Fee Schedule- edit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Fee Schedule edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Fee Schedule edit-- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	editFeeSchedulesMultiple(driver,code, name, editNotes);
		    		}
		    	}
			...
			public void editFeeSchedulesMultiple(WebDriver driver,String code, String name, String notes) throws Exception
			{
			...
			feeScheduleListingPageObject.editFeeSchedule( code, name, notes);
		...
		System.out.println("Done with Fee Schedules-edit  \n\n");
		if (fis != null) 
				fis.close();
	}
}

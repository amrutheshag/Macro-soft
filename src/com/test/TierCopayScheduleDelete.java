...
public class TierCopayScheduleDelete {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TierCopayScheduleDeleteTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Tier Copay Schedule- Delete");
			Log.info("Executing  Tier Copay Schedule- Delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_TestDataToDelete_TierCopaySchedule;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Tier Copay Schedule Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Tier Copay Schedule Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteTierCopayScheduleMultiple(driver,tierCopayName);
		    		}
		    	}
			...
			public void deleteTierCopayScheduleMultiple(WebDriver driver,String tierCopayName) throws Exception
			{
			...
			tierCopaySchedulePageObject.deleteTierCopaySchedule( tierCopayName);
		...
		System.out.println("Done with Tier Copay Schedule-Delete  \n\n");
		if (fis != null)
				fis.close();
	}
}

...
public class MembersCopyMember {

		FileInputStream fis;
		WebDriver driver;
		@Test
		public  void memberCopyTestScript () throws Exception{
			
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n********************************************************************");
			System.out.println("Executing Members- Copy Member  ");
		try{
			String Path=Constant.Path_TestData + Constant.File_TestDataToAdd_Members;
			 	    	...
			 	    	for (int count=1; count<=rowCount; count++){
				 	    	...
				 	    	String newhph= ExcelUtils.getCellData(count,21);
				 	    	String newmname= ExcelUtils.getCellData(count,22);
				 	    	String newmid= ExcelUtils.getCellData(count,23);				 	    	
				 	    	String newdob= ExcelUtils.getCellData(count,24);
				 	    	String hicnid= ExcelUtils.getCellData(count,25);
				 	    	String newfname= ExcelUtils.getCellData(count,26);
				 	    	
			 	   		if (mlname.isEmpty() || mid.isEmpty()) {System.out.println("");}
			 	   		else{
			 	   		System.out.println("-------------------------------------------------------------");
			 	   		System.out.println("Running Members- Copy Members Iteration No: " + ExcelUtils.getCellData(count,0));
			 	   		System.out.println("-------------------------------------------------------------");
			 	   		
			 	   	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Members- Copy Members- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
			 	   		
			 	   		copyMultipleMembers(driver, mid, mlname, mdob, ssn, newmid, newmname, newdob, newfname);
			 	    	}
			 	    	}
	...
	public  void copyMultipleMembers(WebDriver driver, String mid, String mlname, String mdob, String ssn, String newmid, String newmname, String newdob, String newfname) throws Exception {
			...
			membersPageObject.copyMember( mid, mlname, mdob, ssn,  newmid, newmname, newdob, newfname);
	
	}
			  
		@AfterMethod
		  public void afterMethod() throws Exception {
		    System.out.println("Done with Members- Copy Member");

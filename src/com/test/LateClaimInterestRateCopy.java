...
public class LateClaimInterestRateCopy {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void LateClaimsInterestRatesCopyTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Late Claims Interest Rates- Copy");
			Log.info("Executing  Late Claims Interest Rates Copy ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	...
		   		 	Log.info("----------------------------------------------------");
   		 	copyInterestRatesMultiple(driver,effectiveDate, state, benefitProduct, newNotes);
		    		}
		    	}
			...
			public void copyInterestRatesMultiple(WebDriver driver,String effectiveDate, String state, String benefitProduct, String newNotes) throws Exception
			{
			...
			claimInterestObject.InterestRateCopy( effectiveDate, state, benefitProduct, newNotes);
		...
		System.out.println("Done with Late Claim Interest Rates-copy  \n\n");
		if (fis != null) 
				fis.close();
	}
}

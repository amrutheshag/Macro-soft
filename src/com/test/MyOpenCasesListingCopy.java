...
public class MyOpenCasesListingCopy {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyOpenCasesCopyTestScript () throws Exception{
...
public  void copyMyOpenCasesMultiple(WebDriver driver, String subject, String newSubject) throws Exception {
		...
		myOpenCasesPageObject.copyMyOpenCases(subject,  newSubject);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My Open Cases- copy");

...
public class Jira726ClaimTypeAdd {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void FeeScheduleAddClaimQueryTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Fee Schedule- add- Add claim  Query ");
			Log.info("Executing  Fee Schedule- add - Add claim Query ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	...
		   		 	Log.info("----------------------------------------------------");
   		 	addFeeSchedulesAddClaimQueryMultiple(driver,code, name, serviceModifier, claimQueryName, serviceQueryName, claimRequired, claimField, claimRelates, claimToValues, claimIgnoreCase, serviceRequired, serviceField, serviceRelates, serviceToValues, serviceIgnoreCase);
		    		}
		    	}
			...
			feeScheduleListingPageObject.addClaimQueryFeeSchedules(code, name,serviceModifier, claimQueryName, serviceQueryName, claimRequired, claimField, claimRelates, claimToValues, claimIgnoreCase, serviceRequired, serviceField, serviceRelates, serviceToValues, serviceIgnoreCase);
			...
			@AfterMethod
      		...
      		System.out.println("Done with Add Claim Query  \n\n");
      		Log.info("log4j -Done with Add Claim Query  \n\n");
      		if (fis != null) 
      				fis.close();
      	}
}

...
public class CarrierRelationshipTypesDeleteTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CarrierRelationshipTypesDeleteTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Carrier Relationship Types- Delete");
			Log.info("Executing  Carrier Relationship Types- Delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_Delete_CarrierRelationshipTypes;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Carrier Relationship Types Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Carrier Relationship Types Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteCarrierRelationshipTypesMultiple(driver,carrierrelationshipTypesCode);
		    		}
		    	}
			...
			public void deleteCarrierRelationshipTypesMultiple(WebDriver driver,String carrierrelationshipTypesCode) throws Exception
			{
			...
			carrierrelationshipTypesPageObject.deleteCarrierRelationshipTypes(carrierrelationshipTypesCode);
		...
		System.out.println("Done with Carrier Relationship Types-Delete \n\n");
		if (fis != null) 
				fis.close();

...
public class MemberAuthAdd {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void memberAuthorizationAddAuthTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Members Authorizations- Add authorizations ");
	try{
			...
			int rowCount=ExcelUtils.setExcelFile(Path, "Sheet1");
		 	...
		 	String modifier1= ExcelUtils.getCellData(count,27);
		 			...
		 			String modifier3= ExcelUtils.getCellData(count,29);
		 	   		...
		 	   		System.out.println("----------------------------------------------------");
		   		 	System.out.println("Running Members Authorizations -Add Auth- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("----------------------------------------------------");
	 	    		
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Members Authorizations -Add Auth- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
...
public  String addMultipleMemAuth(WebDriver driver, String mid, String mlname, String mfname, String mdob, String mssn, String refReason,String caseManager,String npi,String taxID,String pname, String paddr,String pspeciality, String pos, String icdCode, String refCertType, String treatmentPeriodEndDate, String printedProcessedDate, String pFollowupDate, String extensionDate, String serviceSet, String modifier1, String modifier2, String modifier3) throws Exception {
		...
		String authCode = membersAuthorizationsPageObject.addMemAuth( mid, mlname, mfname, mdob, mssn, refReason,caseManager,npi,taxID,pname, paddr,pspeciality, pos, icdCode, refCertType, treatmentPeriodEndDate, printedProcessedDate, pFollowupDate, extensionDate, serviceSet, modifier1, modifier2, modifier3 );
	...
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Member's Authorizations- Add Authorizations");

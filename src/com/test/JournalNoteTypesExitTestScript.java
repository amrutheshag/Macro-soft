...
public class JournalNoteTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void JournalNoteTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Journal Note Types- Exit");
			Log.info("Executing  Journal Note Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Journal Note Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Journal Note Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitjournalnoteTypesMultiple(driver,journalnoteTypesCode);
		    		}
		    	}
			...
			public void exitjournalnoteTypesMultiple(WebDriver driver,String journalnoteTypesCode) throws Exception
			{
			...
			journalnoteTypesPageObject.exitJournalNoteTypes( journalnoteTypesCode);
			 ...
			 @AfterMethod
	      		...
	      		System.out.println("Done with Journal Note Types-Exit \n\n");
	      		Log.info("log4j -Done with Journal Note Types-Exit \n\n");
	      		if (fis != null)
	      				fis.close();
	      	}
	      }

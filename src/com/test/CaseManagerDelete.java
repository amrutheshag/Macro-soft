...
public class CaseManagerDelete {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CaseManagerDeleteTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Case Manager- delete");
			Log.info("Executing  Case Manager- delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_CaseManagersData_Delete;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Case Manager delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Case Manager delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteCaseManagerMultiple(driver,code, name);
		    		}
		    	}
			...
			public void deleteCaseManagerMultiple(WebDriver driver,String code, String name) throws Exception
			{
			...
			caseManagerListingPageObject.deleteCaseManager( code, name);
		...
		System.out.println("Done with Case Manager-Delete  \n\n");
		if (fis != null)
				fis.close();
	}
}

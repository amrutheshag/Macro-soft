...
public class CaseManagerCopy {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CaseManagerCopyTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Case Manager- Copy");
			Log.info("Executing  Case Manager- Copy ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Case Manager copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Case Manager copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		   		 	copyCaseManagerMultiple(driver,code, name, newCode, newName);
		    		}
		    	}
			...
			public void copyCaseManagerMultiple(WebDriver driver,String code, String name, String newCode, String newName) throws Exception
			{
			...
			caseManagerListingPageObject.copyCaseManager( code, name,newCode, newName);
		...
		System.out.println("Done with Case Manager-Copy \n\n");
		if (fis != null) 
				fis.close();
	}
}

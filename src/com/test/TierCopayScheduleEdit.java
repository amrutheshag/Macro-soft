...
public class TierCopayScheduleEdit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TierCopayScheduleEditTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Tier Copay Schedule- Edit");
			Log.info("Executing  Tier Copay Schedule- Edit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Tier Copay Schedule Edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Tier Copay Schedule Edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	editTierCopayScheduleMultiple(driver,tierCopayName, tierCopayNewCopay);
		    		}
		    	}
			...
			public void editTierCopayScheduleMultiple(WebDriver driver,String tierCopayName, String tierCopayNewCopay) throws Exception
			{
			...
			tierCopaySchedulePageObject.editTierCopaySchedule( tierCopayName, tierCopayNewCopay );
		...
		System.out.println("Done with Tier Copay Schedule-Edit  \n\n");
		if (fis != null)
				fis.close();
	}
}

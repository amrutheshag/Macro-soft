...
public class FCMCRaceCodesAddTestScript {
	 WebDriver driver;
	    FileInputStream fis;
	                    @Test
	                    public void FCMCRaceCodesAddTestScriptTestScript() throws Exception{
	                                    DOMConfigurator.configure("log4j.xml");
	                                    System.out.println("\n*****************************************************\n");
	                                    Log.info("\n*****************************************************\n");
	                                    System.out.println("Executing FCMC Race Codes- Add");
	                                    Log.info("Executing  FCMC Race Codes- Add ");
	                                    ...
	                                    for (int count=1; count<=rowCount; count++){
	                                                    ...
	                                                    System.out.println("\n----------------------------------------------------\n");
	                                                                    System.out.println("FCMC Race Codes Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
	                                                                    System.out.println("\n----------------------------------------------------\n");
	                                                                    Log.info("----------------------------------------------------");
	                                                                    Log.info("FCMC Race Codes Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
	                                                                    Log.info("----------------------------------------------------");
	                                                                    addFCMCRaceCodesMultiple(driver,fcmcraceCodesCode, fcmcraceCodesName);
	                                                    }
	                                    }
	                                    ...
	                                    public void addFCMCRaceCodesMultiple(WebDriver driver,String FCMCRaceCodesCode, String FCMCRaceCodesName) throws Exception
	                                    {
	                                    ...
	                                    FCMCRaceCodesObject.addFCMCRaceCodes(FCMCRaceCodesCode, FCMCRaceCodesName);
	                            		...
	                            		System.out.println("Done with FCMC Race Codes-Add  \n\n");
	                            		Log.info("log4j -Done with FCMC Race Codes-Add  \n\n");

...
public class ContractTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void ContractTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Contract Types- Exit");
			Log.info("Executing  Contract Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Contract Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Contract Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitcontractTypesMultiple(driver,contractTypesCode);
		    		}
		    	}
			...
			public void exitcontractTypesMultiple(WebDriver driver,String contractTypesCode) throws Exception
			{
		...
		*/	
			...
			contractTypesPageObject.exitContractTypes( contractTypesCode);
      		...
      		System.out.println("Done with Contract Types-Exit  \n\n");
      		Log.info("Done with Contract Types-Exit  \n\n");
      		if (fis != null)
      				fis.close();
      	}
      }

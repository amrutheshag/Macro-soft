...
public class MyCaseHistoryExit {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyCaseHistoryExitTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing  Exit My case history ");
	try{
		 	    	...
		 	    	String details= ExcelUtils.getCellData(count,9);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running Exit My case history- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running Exit My case history- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		exitMyCaseHistoryMultiple(driver);
...
public  void exitMyCaseHistoryMultiple(WebDriver driver) throws Exception {
		...
		myCaseHistoryPageObject.exitMyCaseHistory();

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My case history- Exit");

...
public class BenefitProductEdit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitProductEditTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Product- Edit");
			Log.info("Executing  Benefit Product- Edit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		String benefitProductEditRecordMark= ExcelUtils.getCellData(count, 5);
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Product Edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Product Edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	editBenefitProductMultiple(driver,benefitProductCode, benefitProductEditRecordMark);
		    		}
		    	}
			...
			public void editBenefitProductMultiple(WebDriver driver,String benefitProductCode, String benefitProductEditRecordMark) throws Exception
			{
			...
			benefitProductPageObject.editBenefitProduct( benefitProductCode, benefitProductEditRecordMark);
		...
		System.out.println("Done with Benefit Product-Edit \n\n");
		Log.info("Done with Benefit Product-Edit \n\n");
		if (fis != null) 
				fis.close();

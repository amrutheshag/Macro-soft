...
public class TaxPayerAndRateDelete {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TaxPayersAndRateDeleteTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing TaxPayersAndRates- Delete");
			Log.info("Executing  TaxPayersAndRates- Delete");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_TaxPayersAndRatesData_Delete;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("TaxPayersAndRates Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("TaxPayersAndRates Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteTaxPayersAndRateMultiple(driver,taxid, name);
		    		}
		    	}
			...
			public void deleteTaxPayersAndRateMultiple(WebDriver driver,String code, String name) throws Exception
			{
			...
			taxPayersAndRatesListingPageObject.deleteTaxPayerAndRate(code, name);
		...
		System.out.println("Done with TaxPayersAndRates-Delete \n\n");
		if (fis != null) 
				fis.close();
	}
}

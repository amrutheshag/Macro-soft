...
public class ServiceCodesAddTestScript {
	 WebDriver driver;
     FileInputStream fis;
                     @Test
                     public void ServiceCodesAddTestScript1() throws Exception{
                                     DOMConfigurator.configure("log4j.xml");
                                     System.out.println("\n*****************************************************\n");
                                     Log.info("\n*****************************************************\n");
                                     System.out.println("Executing Service Codes- Add");
                                     Log.info("Executing  Service Codes- Add ");
                                     ...
                                     for (int count=1; count<=rowCount; count++){
                                                     ...
                                                     System.out.println("\n----------------------------------------------------\n");
                                                                     System.out.println("Service Codes Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                     System.out.println("\n----------------------------------------------------\n");
                                                                     Log.info("----------------------------------------------------");
                                                                     Log.info("Service Codes Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                     Log.info("----------------------------------------------------");
                                                                     addserviceCodesMultiple(driver,serviceCodesCode, ServiceCodesDescriptionInput, Category);
                                                     }
                                     }
                                     ...
                                     public void addserviceCodesMultiple(WebDriver driver,String serviceCodesCode, String ServiceCodesDescriptionInput, String Category) throws Exception
                                     {
                                    ...
                                    ServiceCodesObject.addServiceCodes(serviceCodesCode, ServiceCodesDescriptionInput, Category);
                             		...
                             		System.out.println("Done with Service Codes-Add   \n\n");
                             		if (fis != null) 
                             				fis.close();
                             	}

...
public class CarrierRelationshipTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CarrierRelationshipTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Carrier Relationship Types- Exit");
			Log.info("Executing  Carrier Relationship Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Carrier Relationship Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Carrier Relationship Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitCarrierRelationshipTypesMultiple(driver,carrierrelationshipTypesCode);
		    		}
		    	}
			...
			public void exitCarrierRelationshipTypesMultiple(WebDriver driver,String carrierrelationshipTypesCode) throws Exception
			{
			...
			carrierrelationshipTypesPageObject.exitCarrierRelationshipTypes( carrierrelationshipTypesCode);
		...
		System.out.println("Done with Carrier Relationship Types-Exit  \n\n");
		if (fis != null) 
				fis.close();
	}
}

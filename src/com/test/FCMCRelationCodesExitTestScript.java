...
public class FCMCRelationCodesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void fcmcrelationCodesExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing FCMC Relation Codes- Exit");
			Log.info("Executing  FCMC Relation Codes- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("FCMC Relation Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("FCMC Relation Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitfcmcrelationCodesMultiple(driver,fcmcrelationCodesCode);
		    		}
		    	}
			...
			public void exitfcmcrelationCodesMultiple(WebDriver driver,String fcmcrelationCodesCode) throws Exception
			{
			...
			homePageObject.clickReferencegotoFCMCRelationCodes();	
				...
				fcmcrelationCodesPageObject.exitFCMCRelationCodes( fcmcrelationCodesCode);
      		...
      		System.out.println("Done with FCMC Relation Codes-Exit  \n\n");
      		Log.info("log4j -Done with FCMC Relation Codes-Exit  \n\n");

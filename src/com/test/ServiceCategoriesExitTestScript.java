...
public class ServiceCategoriesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void ServiceCategoriesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Service Categories- Exit");
			Log.info("Executing  Service Categories- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Service Categories Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Service Categories Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitServiceCategoriesMultiple(driver,serviceCategoriesCode);
		    		}
		    	}
			...
			public void exitServiceCategoriesMultiple(WebDriver driver,String serviceCategoriesCode) throws Exception
			{
			...
			serviceCategoriesPageObject.exitServiceCategories( serviceCategoriesCode);
			...
			@AfterMethod
      		...
      		System.out.println("Done with Service Categories-Exit \n\n");
      		Log.info("log4j-Done with Service Categories-Exit \n\n");
      		if (fis != null)
      				fis.close();
      	}
      }

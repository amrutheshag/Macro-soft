...
public class HCFAServiceTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void HCFAServiceTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing HCFA Service Types- Exit");
			Log.info("Executing  HCFA Service Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("HCFA Service Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("HCFA Service Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitHCFAServiceTypesMultiple(driver,hcfaserviceTypesCode);
		    		}
		    	}
			...
			public void exitHCFAServiceTypesMultiple(WebDriver driver,String hcfaserviceTypesCode) throws Exception
			{
			...
			hcfaserviceTypesPageObject.exitHCFAServiceTypes( hcfaserviceTypesCode);
			  ...
			  @AfterMethod
	      		...
	      		System.out.println("Done with HCFA Service Types-Exit  \n\n");
	      		Log.info("log4j -Done with HCFA Service Types-Exit  \n\n");
	      		if (fis != null)
	      				fis.close();

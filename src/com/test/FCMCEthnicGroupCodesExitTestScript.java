...
public class FCMCEthnicGroupCodesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void fcmcethnicgroupCodesExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing FCMC Ethnic Group Codes- Exit");
			Log.info("Executing  FCMC Ethnic Group Codes- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("FCMC Ethnic Group Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("FCMC Ethnic Group Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitfcmcethnicgroupCodesMultiple(driver,fcmcethnicgroupCodesCode);
		    		}
		    	}
			...
			public void exitfcmcethnicgroupCodesMultiple(WebDriver driver,String fcmcethnicgroupCodesCode) throws Exception
			{
			...
			fcmcethnicgroupCodesPageObject.exitFCMCEthnicGroupCodes( fcmcethnicgroupCodesCode);
			...
			@AfterMethod
      		...
      		System.out.println("Done with FCMC Ethnic Group Codes-Exit  \n\n");
      		Log.info("log4j -Done with FCMC Ethnic Group Codes-Exit  \n\n");
      		}
      }

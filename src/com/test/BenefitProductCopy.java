...
public class BenefitProductCopy {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitProductCopyTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Product- Copy");
			Log.info("Executing  Benefit Product- Copy ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Product Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Product Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	copyBenefitProductMultiple(driver,benefitProductCode, benefitProductNewCode, benefitProductNewDescription);
		    		}
		    	}
			...
			public void copyBenefitProductMultiple(WebDriver driver,String benefitProductCode, String benefitProductNewCode, String benefitProductNewDescription) throws Exception
			{
			...
			benefitProductPageObject.copyBenefitProduct( benefitProductCode, benefitProductNewCode, benefitProductNewDescription);
		...
		System.out.println("Done with Benefit Product-Copy \n\n");
		Log.info("Done with Benefit Product-Copy \n\n");
		if (fis != null)
				fis.close();

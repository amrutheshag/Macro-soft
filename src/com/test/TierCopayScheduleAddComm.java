...
public class TierCopayScheduleAddComm {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TierCopayScheduleAddCommTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Tier Copay Schedule- Add Comm");
			Log.info("Executing  Tier Copay Schedule- Add Comm ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Tier Copay Schedule Add Comm- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Tier Copay Schedule Add Comm- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	addCommTierCopayScheduleMultiple(driver,tierCopayName, tierCopayCommSubject, tierCopayCommNoteType, tierCopayCommNoteMedium, tierCopayCommNoteDetails );
		    		}
		    	}
			...
			public void addCommTierCopayScheduleMultiple(WebDriver driver,String tierCopayName, String tierCopayCommSubject, String tierCopayCommNoteType, String tierCopayCommNoteMedium, String tierCopayCommNoteDetails ) throws Exception
			{
			...
			tierCopaySchedulePageObject.addCommTierCopaySchedule( tierCopayName, tierCopayCommSubject, tierCopayCommNoteType, tierCopayCommNoteMedium, tierCopayCommNoteDetails );
		...
		System.out.println("Done with Tier Copay Schedule-Add Comm  \n\n");
		if (fis != null)
				fis.close();
	}
}

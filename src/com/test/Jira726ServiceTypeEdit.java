...
public class Jira726ServiceTypeEdit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TaxPayersAndRateEditServiceTypeQueryTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing TaxPayersAndRates- Edit Service Type Query");
			Log.info("Executing  TaxPayersAndRates- Edit Service Type Query ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("TaxPayersAndRates Edit Service Type Query- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("TaxPayersAndRates Edit Service Type Query- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	editTaxPayersAndRateMultipleServiceTypeQuery(driver,taxid, name, editClaimType, editServiceType);
		    		}
		    	}
			...
			public void editTaxPayersAndRateMultipleServiceTypeQuery(WebDriver driver,String code, String name, String editClaimType, String editServiceType) throws Exception
			{
			...
			taxPayersAndRatesListingPageObject.editTaxPayerAndRateServiceTypeQuery(code, name, editClaimType, editServiceType);

...
public class MyCaseHistoryDelete {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyCaseHistoryDeleteTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing  Delete My case history ");
	try{
		 	    	String Path=Constant.Path_TestData + Constant.File_TestDataForMyCaseHistoryTestData_Delete;
		 	    	...
		 	    	String newFollowUpDate = ExcelUtils.getCellData(count,10);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running delete My case history- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running delete My Case History- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		deleteMyCaseHistoryMultiple(driver,subject);
...
public  void deleteMyCaseHistoryMultiple(WebDriver driver, String subject) throws Exception {
		...
		myCaseHistoryPageObject.deleteMyCaseHistory(subject);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My case history- Delete");

...
public class LateClaimInterestRateEdit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void LateClaimsInterestRatesEditTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Late Claims Interest Rates- Edit");
			Log.info("Executing  Late Claims Interest Rates Edit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		String mimTotalToBeMet= ExcelUtils.getCellData(count,10);
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Late Claims Interest Rates Edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Late Claims Interest Rates Edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	editInterestRatesMultiple(driver,effectiveDate, state, benefitProduct, newAnnualInterestRate, newAnnualPenaltyRate);
		    		}
		    	}
			...
			public void editInterestRatesMultiple(WebDriver driver,String effectiveDate, String state, String benefitProduct, String newAnnualInterestRate, String newAnnualPenaltyRate) throws Exception
			{
			...
			claimInterestObject.InterestRateEdit( effectiveDate, state, benefitProduct, newAnnualInterestRate, newAnnualPenaltyRate);
		...
		System.out.println("Done with Late Claim Interest Rates-Edit  \n\n");
		if (fis != null) 
				fis.close();
	}
}

...
public class BenefitClassAdd {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitClassAddTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Class- Add");
			Log.info("Executing  Benefit Class- Add ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Class Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Class Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	addBenefitClassMultiple(driver,benefitClassCode, benefitClassDescription);
		    		}
		    	}
			...
			public void addBenefitClassMultiple(WebDriver driver,String benefitClassCode, String benefitClassDescription) throws Exception
			{
		...
		BenefitClass benefitClassPageObject = new BenefitClass(driver);
			benefitClassPageObject.addBenefitClass( benefitClassCode, benefitClassDescription);
		...
		System.out.println("Done with Benefit Class-Add\n\n");
		Log.info("Done with Benefit Class-Add\n\n");
		if (fis != null) 
				fis.close();

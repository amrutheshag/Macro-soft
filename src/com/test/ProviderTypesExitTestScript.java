...
public class ProviderTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void ProviderTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Provider Types- Exit");
			Log.info("Executing  Provider Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Provider Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Provider Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitProviderTypesMultiple(driver,providerTypesCode);
		    		}
		    	}
			...
			public void exitProviderTypesMultiple(WebDriver driver,String providerTypesCode) throws Exception
			{
			...
			providerTypesPageObject.exitProviderTypes( providerTypesCode);
		...
		System.out.println("Done with Provider Types-Exit  \n\n");
		Log.info("log4j -Done with Provider Types-Exit  \n\n");
		if (fis != null)
				fis.close();
	}
}

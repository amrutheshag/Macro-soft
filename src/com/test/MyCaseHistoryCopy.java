...
public class MyCaseHistoryCopy {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyCaseHistoryCopyTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing  Copy My Case History ");
	try{
		 	    	...
		 	    	String newSubject = ExcelUtils.getCellData(count,  11);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running Copy My Case History- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running Copy My Case History- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		copyMyCaseHistoryMultiple(driver,subject,  newSubject);
...
public  void copyMyCaseHistoryMultiple(WebDriver driver, String subject, String newSubject) throws Exception {
		...
		myCaseHistoryPageObject.copyMyCaseHistory(subject,  newSubject);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My case history- copy");

...
public class BenefitPremiumPaymentModesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitPremiumPaymentModesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Premium Payment Modes- Exit");
			Log.info("Executing  Benefit Premium Payment Modes- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Premium Payment Modes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Premium Payment Modes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitbenefitpremiumpaymentModesMultiple(driver,benefitpremiumpaymentModesCode);
		    		}
		    	}
			...
			public void exitbenefitpremiumpaymentModesMultiple(WebDriver driver,String benefitpremiumpaymentModesCode) throws Exception
			{
...
System.out.println("Blank Home Page");
           Log.info("log4j - msg -Blank Home Page");
			...
			benefitpremiumpaymentModesPageObject.exitBenefitPremiumPaymentModes( benefitpremiumpaymentModesCode);
		...
		System.out.println("Done with Benefit Premium Payment Modes-Exit  \n\n");
		Log.info("log4j -Done with Benefit Premium Payment Modes-Exit  \n\n");
		if (fis != null)
				fis.close();
	}
}

...
public class PlaceofServiceTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void PlaceofServiceTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Place of Service Types- Exit");
			Log.info("Executing  Place of Service Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Place of Service Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Place of Service Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitPlaceofServiceTypesMultiple(driver,placeofserviceTypesCode);
		    		}
		    	}
			...
			public void exitPlaceofServiceTypesMultiple(WebDriver driver,String placeofserviceTypesCode) throws Exception
			{
			...
			placeofserviceTypesPageObject.exitPlaceofServiceTypes( placeofserviceTypesCode);
			...
			@AfterMethod
     		...
     		System.out.println("Done with Place of Service Types-Exit \n\n");
     		Log.info("log4j -Done with Place of Service Types-Exit \n\n");

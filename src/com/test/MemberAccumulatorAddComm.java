...
public class MemberAccumulatorAddComm {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MemberAccumulatorAddCommunicationTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Member Accumulators- Add Communication ");
	try{
			...
			int rowCount=ExcelUtils.setExcelFile(Path, "Sheet1");
		 	...
		 	String  details = ExcelUtils.getCellData(count,13);
		 	   		...
		 	   		System.out.println("----------------------------------------------------");
		   		 	System.out.println("Running Member Accumulators -Add Comm- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("----------------------------------------------------");
	 	    		
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Member Accumulaotrs -Add Comm- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		 	   		memberAccumulatorAddCommunicationMultiple(driver, mid, mlname, mfname, mdob, mssn,deniedClaimNo, deniedServiceFromDate, deniedServiceToDate, subject, type, noteType, medium, details);
...
public void memberAccumulatorAddCommunicationMultiple(WebDriver driver, String mid, String mlname, String mfname, String mdob, String mssn, String deniedClaimNo, String deniedServiceFromDate, String deniedServiceToDate, String subject, String type, String noteType, String medium, String details) throws Exception {
		...
		memberAccumulatorListingPageObject.memberAccumulatorAddComm( mid, mlname, mfname, mdob, mssn,deniedClaimNo, deniedServiceFromDate, deniedServiceToDate, subject, type, noteType,medium,  details);
	...
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Member Accumulators- Add Communication");

...
public class CaseManagerAddComm {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CaseManagerAddCommTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Case Manager- Add Comm");
			Log.info("Executing  Case Manager- Add Comm ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Case Manager Add Comm- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Case Manager Add Comm- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		   		 	addCommCaseManagerMultiple(driver,code, name, subject, type, followupDate, priority, noteType, medium, details);
		    		}
		    	}
			...
			public void addCommCaseManagerMultiple(WebDriver driver,String code, String name, String subject, String type, String followupDate, String priority, String notetype, String medium, String details) throws Exception
			{
			...
			caseManagerListingPageObject.addCommCaseManager( code, name, subject, type, followupDate, priority, notetype, medium, details);
		...
		System.out.println("Done with Case Manager-Add Comm \n\n");
		Log.info("Done with Case Manager-Add Comm \n\n");
		if (fis != null) 
				fis.close();
	}
}

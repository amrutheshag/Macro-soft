...
public class ContractTypesAddTestScript {
	 WebDriver driver;
	    FileInputStream fis;
	                    @Test
	                    public void ContractTypesAddTestScriptTestScript() throws Exception{
	                                    DOMConfigurator.configure("log4j.xml");
	                                    System.out.println("\n*****************************************************\n");
	                                    Log.info("\n*****************************************************\n");
	                                    System.out.println("Executing Contract Types- Add");
	                                    Log.info("Executing  Contract Types- Add ");
	                                    ...
	                                    for (int count=1; count<=rowCount; count++){
	                                                    ...
	                                                    System.out.println("\n----------------------------------------------------\n");
	                                                                    System.out.println("Contract Types Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
	                                                                    System.out.println("\n----------------------------------------------------\n");
	                                                                    Log.info("----------------------------------------------------");
	                                                                    Log.info("Contract Types Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
	                                                                    Log.info("----------------------------------------------------");
	                                                                    addContractTypesMultiple(driver,contractTypesCode, contractTypesName);
	                                                    }
	                                    }
	                                    ...
	                                    public void addContractTypesMultiple(WebDriver driver,String ContractTypesCode, String ContractTypesName) throws Exception
	                                    {
	                                    ...
	                                    ContractTypesObject.addContractTypes(ContractTypesCode, ContractTypesName);
	                                    
	                                    }
	                                    @AfterMethod
	                            		public void afterMethod() throws Exception {
	                            		if (driver!=null) driver.quit();
	                            		System.out.println("Done with Contract Types-Add  \n\n");
	                            		Log.info("Done with  Contract Types-Add  \n\n");
	                            		if (fis != null)
	                            				fis.close();

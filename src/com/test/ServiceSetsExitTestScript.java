...
public class ServiceSetsExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void ServiceSetsExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Service Sets- Exit");
			Log.info("Executing  Service Sets- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Service Sets Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Service Sets Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitServiceSetsMultiple(driver,serviceSetsCode);
		    		}
		    	}
			...
			public void exitServiceSetsMultiple(WebDriver driver,String serviceSetsCode) throws Exception
			{
			...
			serviceSetsPageObject.exitServiceSets(serviceSetsCode);
			 ...
			 @AfterMethod
      		...
      		System.out.println("Done with Service Sets-Exit \n\n");
      		Log.info("log4j-Done with Service Sets-Exit \n\n");
      		if (fis != null)
      				fis.close();
      	}
      }

...
public class FCMCActionCodesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void FCMCActionCodesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing FCMC Action Codes- Exit");
			Log.info("Executing  FCMC Action Codes- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("FCMC Action Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("FCMC Action Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitfcmcactionCodesMultiple(driver,fcmcactionCodesCode);
		    		}
		    	}
			...
			public void exitfcmcactionCodesMultiple(WebDriver driver,String fcmcactionCodesCode) throws Exception
			{
			...
			fcmcactionCodesPageObject.exitFCMCActionCodes( fcmcactionCodesCode);
		...
		System.out.println("Done with FCMC Action Codes-Exit  \n\n");
		if (fis != null)
				fis.close();
	}
}

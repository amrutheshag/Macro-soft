...
public class ServiceCodesExitTestScript {
	WebDriver driver;
    FileInputStream fis;
                    @Test
                    public void ServiceCodesExitTestScript1() throws Exception{
                                    DOMConfigurator.configure("log4j.xml");
                                    System.out.println("\n*****************************************************\n");
                                    Log.info("\n*****************************************************\n");
                                    System.out.println("Executing Service Codes- exit");
                                    Log.info("Executing  Service Codes- exit ");
                                    ...
                                    for (int count=1; count<=rowCount; count++){
                                                    ...
                                                    System.out.println("\n----------------------------------------------------\n");
                                                                    System.out.println("Service Codes exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                    System.out.println("\n----------------------------------------------------\n");
                                                                    Log.info("----------------------------------------------------");
                                                                    Log.info("Service Codes exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                    Log.info("----------------------------------------------------");
                                                                    exitserviceCodesMultiple(driver,serviceCodesCode);
                                                    }
                                    }
                                    ...
                                    public void exitserviceCodesMultiple(WebDriver driver,String serviceCodesCode) throws Exception
                                    {
                                    ...
                                    ServiceCodesObject.exitServiceCodes(serviceCodesCode);
                            		...
                            		System.out.println("Done with Service Codes-exit  \n\n");

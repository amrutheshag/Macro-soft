...
public class CredentiallingStatusesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CredentiallingStatusesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Credentialling Statuses- Exit");
			Log.info("Executing  Credentialling Statuses- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Credentialling Statuses Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Credentialling Statuses Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitCredentiallingStatusesMultiple(driver,credentiallingStatusesCode);
		    		}
		    	}
			...
			public void exitCredentiallingStatusesMultiple(WebDriver driver,String credentiallingStatusesCode) throws Exception
			{
			...
			credentiallingStatusesPageObject.exitCredentiallingStatuses( credentiallingStatusesCode);
			  ...
			  @AfterMethod
       		...
       		System.out.println("Done with Credentialling Statuses-Exit  \n\n");
       		Log.info("Done with Credentialling Statuses-Exit  \n\n");
       		if (fis != null) 
       				fis.close();
       	}
       }

...
public class EDISubmittersDelete {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void EDISubmitterDeleteTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing EDISubmitter- Delete");
			Log.info("Executing  EDISubmitter- Delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_EDISubmittersTestData_Delete;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("EDI SUbmitter Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("EDI Submitter Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteEDISubmitterMultiple(driver,ediSubmitterName, ediSubmitterID);
		    		}
		    	}
			...
			public void deleteEDISubmitterMultiple(WebDriver driver,String name, String id) throws Exception
			{
			...
			//Delete EDI Submitters
			EDISubmitterListingPage EDISubmittersListingPageObject = new EDISubmitterListingPage(driver);
			EDISubmittersListingPageObject.deleteEDISubmitter( name, id);
			}

		@AfterMethod
		public void afterMethod() throws Exception {
		if (driver!=null) driver.quit();
		System.out.println("Done with EDI Submitterss-Delete \n\n");
		if (fis != null)
				fis.close();
	}
}

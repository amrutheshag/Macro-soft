...
public class BenefitPlanExit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitPlanExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Plan- Exit");
			Log.info("Executing  Benefit Plan Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Plan Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Plan Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitBenefitClassMultiple(driver,benefitPlanCode, benefitPlanName, benefitPlanPayer);
		    		}
		    	}
			...
			public void exitBenefitClassMultiple(WebDriver driver,String benefitPlanCode, String benefitPlanName, String benefitPlanPayer) throws Exception
			{
			...
			benefitPlanPageObject.exitBenefitPlan( benefitPlanCode, benefitPlanName, benefitPlanPayer);
		...
		System.out.println("Done with Benefit Plan-Exit  \n\n");
		Log.info("Done with Benefit Plan-Exit  \n\n");
		if (fis != null) 
				fis.close();

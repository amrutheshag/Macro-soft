...
public class URCaseProblemTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void URCaseProblemTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing UR Case/Problem Types- Exit");
			Log.info("Executing  UR Case/Problem Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("UR Case/Problem Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("UR Case/Problem Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitURCaseProblemTypesMultiple(driver,urcaseproblemTypesCode);
		    		}
		    	}
			...
			public void exitURCaseProblemTypesMultiple(WebDriver driver,String urcaseproblemTypesCode) throws Exception
			{
			...
			urcaseproblemTypesPageObject.exitURCaseProblemTypes(urcaseproblemTypesCode);
			  ...
			  @AfterMethod
	      		...
	      		System.out.println("Done with UR Case/Problem Types-Exit \n\n");
	      		Log.info("log4j-Done with UR Case/Problem Types-Exit \n\n");
	      		if (fis != null)
	      				fis.close();
	      	}
	      }

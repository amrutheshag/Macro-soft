...
public class AcademicDegreesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void AcademicDegreesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Academic Degrees- Exit");
			Log.info("Executing  Academic Degrees- Exit ");
			...
			try{
		    	...
		    	//	String academicDegreesNewDescription= ExcelUtils.getCellData(count, 4);
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Academic Degrees Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Academic Degrees Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitAcademicDegreesMultiple(driver, academicDegreesCode);
		    		}
		    	}
			...
			public void exitAcademicDegreesMultiple(WebDriver driver, String academicDegreesCode) throws Exception
			{
			...
			academicDegreesPageObject.exitAcademicDegrees( academicDegreesCode);
			...
			System.out.println("Done with Academic Degrees-Exit \n\n");
			Log.info("log4j -Done with Academic Degrees-Exit \n\n");
			if (fis != null) 
					fis.close();

...
public class BenefitProductDelete {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitProductDeleteTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Product- Delete");
			Log.info("Executing  Benefit Product- Delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_Delete_BenefitProduct;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Product Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Product Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteBenefitProductMultiple(driver,benefitProductCode);
		    		}
		    	}
			...
			public void deleteBenefitProductMultiple(WebDriver driver,String benefitProductCode) throws Exception
			{
			...
			benefitProductPageObject.deleteBenefitProduct( benefitProductCode);
		...
		System.out.println("Done with Benefit Product-Delete \n\n");
		Log.info("Done with Benefit Product-Delete \n\n");
		if (fis != null) 
				fis.close();

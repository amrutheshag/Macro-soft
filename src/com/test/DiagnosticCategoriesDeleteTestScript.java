...
public class DiagnosticCategoriesDeleteTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void DiagnosticCategoriesDeleteTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Diagnostic Categories- Delete");
			Log.info("Executing  Diagnostic Categories- Delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_Delete_DiagnosticCategories;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Diagnostic Categories Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Diagnostic Categories Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteDiagnosticCategoriesMultiple(driver,diagnosticCategoriesCode, diagnosticCategoriesDescription);
		    		}
		    	}
			...
			public void deleteDiagnosticCategoriesMultiple(WebDriver driver,String diagnosticCategoriesCode, String diagnosticCategoriesDescription) throws Exception
			{
			...
			diagnosticCategoriesPageObject.deleteDiagnosticCategories( diagnosticCategoriesCode, diagnosticCategoriesDescription);
		...
		System.out.println("Done with Diagnostic Categories-Delete \n\n");
		if (fis != null)
				fis.close();

...
public class MembersAddMember {
	FileInputStream fis;
	WebDriver driver;
	
	
	@Test
	public  void memberAddTestScript () throws Exception{
	 
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Members- Add Member  ");
		Log.info("Executing Members- Add Member  ");
	...
	try{
		 	    	...
		 	    	String hicnid= ExcelUtils.getCellData(count,25);
		 	   		...
		 	   		if (mlname.isEmpty() || mid.isEmpty()) {}
		 	   		else{
		 	   		System.out.println("----------------------------------------------------");
		   		 	System.out.println("Running Members- Add Members Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("----------------------------------------------------");
	 	    		
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Members- Add Members- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		 	   		addMultipleMembers(driver, mid, mlname,mfname, mdob, ssn, maddress, mcity, mstate, mzip, coverageEffectivePeriod, relationToSubscriber,payerCode, coverageSequence, coverageExtent);
...
public  void addMultipleMembers(WebDriver driver, String mid, String mlname, String mfname, String mdob, String ssn, String maddress, String mcity, String mstate, String mzip, String coverageEffectivePeriod, String relationToSubscriber,String payerCode, String coverageSequence, String coverageExtent) throws Exception {
		...
		membersPageObject.addMember( mid, mlname, mfname, mdob, ssn, maddress,mcity, mstate, mzip, coverageEffectivePeriod, relationToSubscriber,payerCode, coverageSequence, coverageExtent);
		
}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Members- Add Member");

...
public class CoverageManualEntryReasonsDeleteTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CoverageManualEntryReasonsDeleteTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Coverage Manual Entry Reasons- Delete");
			Log.info("Executing  Coverage Manual Entry Reasons- Delete ");
			
			
			try{
				String Path=Constant.Path_TestData + Constant.File_Delete_CoverageManualEntryReasons;
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Coverage Manual Entry Reasons Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Coverage Manual Entry Reasons Delete- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	deleteCoverageManualEntryReasonsMultiple(driver,coveragemanualentryReasonsCode);
		    		}
		    	}
			...
			public void deleteCoverageManualEntryReasonsMultiple(WebDriver driver,String coveragemanualentryReasonsCode) throws Exception
			{
		...
		*/	
			...
			coveragemanualentryReasonsPageObject.deleteCoverageManualEntryReasons(coveragemanualentryReasonsCode);
		...
		System.out.println("Done with Coverage Manual Entry Reasons-Delete \n\n");
		if (fis != null)
				fis.close();

...
public class MyOpenCasesListingEdit {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyOpenCasesEditTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing edit My Open Cases ");
	try{
		 	    	...
		 	    	String newFollowUpDate = ExcelUtils.getCellData(count,10);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running editMy Open cases- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running edit My Open Cases- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		editMyOpenCasesMultiple(driver,subject,  followUpDate, newFollowUpDate);
...
public  void editMyOpenCasesMultiple(WebDriver driver, String subject, String followUpDate,String newFollowUpDate) throws Exception {
		...
		myOpenCasesPageObject.editMyOpenCases(subject,  followUpDate, newFollowUpDate);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My Open Cases- edit");

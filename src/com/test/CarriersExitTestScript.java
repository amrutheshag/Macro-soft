...
public class CarriersExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CarriersExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Carriers- Exit");
			Log.info("Executing  Carriers- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Carriers Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Carriers Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitCarriersMultiple(driver,carriersCode);
		    		}
		    	}
			...
			public void exitCarriersMultiple(WebDriver driver,String carriersCode) throws Exception
			{
			...
			carriersPageObject.exitCarriers( carriersCode);
		...
		System.out.println("Done with Carriers-Exit  \n\n");
		if (fis != null) 
				fis.close();

...
public class FeeScheduleExit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void FeeScheduleExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Fee Schedule- Exit");
			Log.info("Executing  Fee Schedule- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Fee Schedule Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Fee Schedule Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitFeeSchedulesMultiple(driver,code, name);
		    		}
		    	}
			...
			public void exitFeeSchedulesMultiple(WebDriver driver,String code, String name) throws Exception
			{
			...
			feeScheduleListingPageObject.exitFeeSchedule( code, name);
		...
		System.out.println("Done with Fee Schedules-Exit  \n\n");
		if (fis != null) 
				fis.close();
	}
}

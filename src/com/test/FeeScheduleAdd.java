...
public class FeeScheduleAdd {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void FeeScheduleAddTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Fee Schedule- add");
			Log.info("Executing  Fee Schedule- add ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Fee Schedule Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Fee Schedule Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	addFeeSchedulesMultiple(driver,code, name);
		    		}
		    	}
			...
			public void addFeeSchedulesMultiple(WebDriver driver,String code, String name) throws Exception
			{
			...
			feeScheduleListingPageObject.addFeeSchedule( code, name);
		...
		System.out.println("Done with Fee Schedules-Add  \n\n");
		if (fis != null) 
				fis.close();
	}
}

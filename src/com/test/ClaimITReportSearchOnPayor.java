...
public class ClaimITReportSearchOnPayor {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void ClaimITReportWithPayorTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Claim IT Report with payor");
			Log.info("Executing Claim IT Report with payor");
			...
			public void claimITReportWithPayorMultiple(WebDriver driver, String approvedServiceOnly, String openClaimsOnly, String extractClaimAndServiceData, String denyServices, String providerID, String memberID, String payor, String from, String to, String claimQuery, String insurerPayor, String checkBilaterals, String checkCCI, String checkGlobalPeriods, String checkLCPDiagnosis, String assistantSurgeon, String clientFault, String providerIDInClaimITReport, String payorInClaimITReport) throws Exception{
			...
			ClaimITReportPageObject.searchOnPayorPrintClaimITReport( approvedServiceOnly, openClaimsOnly, extractClaimAndServiceData, denyServices, providerID, memberID, payor, from, to, claimQuery, insurerPayor, checkBilaterals, checkCCI, checkGlobalPeriods, checkLCPDiagnosis, assistantSurgeon, clientFault, providerIDInClaimITReport, payorInClaimITReport);
			}

		@AfterMethod
		public void afterMethod() throws Exception {
		if (driver!=null) driver.quit();
		System.out.println("Done with Claim IT Report- with Payor \n\n");
		if (fis != null)
				fis.close();

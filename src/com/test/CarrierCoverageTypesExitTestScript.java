...
public class CarrierCoverageTypesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CarrierCoverageTypesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Carrier Coverage Types- Exit");
			Log.info("Executing  Carrier Coverage Types- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Carrier Coverage Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Carrier Coverage Types Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitCarrierCoverageTypesMultiple(driver,carriercoverageTypesCode);
		    		}
		    	}
			...
			public void exitCarrierCoverageTypesMultiple(WebDriver driver,String carriercoverageTypesCode) throws Exception
			{
			...
			carriercoverageTypesPageObject.exitCarrierCoverageTypes( carriercoverageTypesCode);
		...
		System.out.println("Done with Carrier Coverage Types-Exit  \n\n");
		if (fis != null) 
				fis.close();
	}
}

...
public class TierCopayScheduleCopy {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TierCopayScheduleCopyTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Tier Copay Schedule- Copy");
			Log.info("Executing  Tier Copay Schedule- Copy ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Tier Copay Schedule Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Tier Copay Schedule Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	copyTierCopayScheduleMultiple(driver,tierCopayName, tierCopayNewName);
		    		}
		    	}
			...
			public void copyTierCopayScheduleMultiple(WebDriver driver,String tierCopayName, String tierCopayNewName) throws Exception
			{
			...
			tierCopaySchedulePageObject.copyTierCopaySchedule( tierCopayName, tierCopayNewName);
		...
		System.out.println("Done with Tier Copay Schedule-Copy  \n\n");
		if (fis != null) 
				fis.close();
	}
}

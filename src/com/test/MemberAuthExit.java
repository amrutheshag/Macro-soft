...
public class MemberAuthExit {

	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void memberAuthorizationExitTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Members Authorizations- Exit  ");
	try{
					...
					String Path=Constant.Path_TestData + Constant.File_TestDataToAdd_MemAuth;
		 	    	...
		 	    	String refCertNo= ExcelUtils.getCellData(count,21);
		 	   		...
		 	   		System.out.println("----------------------------------------------------");
		   		 	System.out.println("Running Members Authorizations -Exit- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("----------------------------------------------------");
	 	    		
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Members Authorizations -Exit- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		 	   		exitMultipleMA(driver, mid, mlname, mfname, mdob, mssn, refCertNo);
...
public  void exitMultipleMA(WebDriver driver, String mid, String mlname, String mfname, String mdob, String mssn, String refCertNo) throws Exception {
		...
		membersAuthorizationsPageObject.exitMemAuth( mid, mlname, mfname, mdob, mssn, refCertNo);
	
}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Members Authorizations- Exit Member");

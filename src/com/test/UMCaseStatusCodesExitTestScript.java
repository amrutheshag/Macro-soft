...
public class UMCaseStatusCodesExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void UMCaseStatusCodesExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing UM Case Status Codes- Exit");
			Log.info("Executing  UM Case Status Codes- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("UM Case Status Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("UM Case Status Codes Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitUMCaseStatusCodesMultiple(driver,umcasestatusCodesCode);
		    		}
		    	}
			...
			public void exitUMCaseStatusCodesMultiple(WebDriver driver,String umcasestatusCodesCode) throws Exception
			{
			...
			umcasestatusCodesPageObject.exitUMCaseStatusCodes(umcasestatusCodesCode);
       		...
       		System.out.println("Done with UM Case Status Codes-Exit \n\n");
       		Log.info("log4j-Done with UM Case Status Codes-Exit \n\n");
       		if (fis != null)
       				fis.close();
       	}
       }

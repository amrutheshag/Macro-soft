...
public class CaseManagerEdit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void CaseManagerEditTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Case Manager- Edit");
			Log.info("Executing  Case Manager- Edit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Case Manager edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Case Manager edit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		   		 	editCaseManagerMultiple(driver,code, name, city);
		    		}
		    	}
			...
			public void editCaseManagerMultiple(WebDriver driver,String code, String name, String city) throws Exception
			{
			...
			caseManagerListingPageObject.editCaseManager( code, name,city);
		...
		System.out.println("Done with Case Manager-Edit \n\n");
		if (fis != null) 
				fis.close();
	}
}
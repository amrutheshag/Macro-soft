...
public class EDISubmittersAdd {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void EDISubmitterAddTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing EDISubmitter- Add");
			Log.info("Executing  EDISubmitter- Add ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("EDI SUbmitter Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("EDI Submitter Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	addEDISubmitterMultiple(driver,ediSubmitterName, ediSubmitterID, definition, mappingFormat, splitServiceCode);
		    		}
		    	}
			...
			public void addEDISubmitterMultiple(WebDriver driver,String name, String id, String definition, String format, String splitServiceCode) throws Exception
			{
			...
			EDISubmittersListingPageObject.addEDISubmitter( name, id, definition, format, splitServiceCode);
			}

		@AfterMethod
		public void afterMethod() throws Exception {
		if (driver!=null) driver.quit();
		System.out.println("Done with EDI Submitterss-Add  \n\n");
		if (fis != null) 
				fis.close();

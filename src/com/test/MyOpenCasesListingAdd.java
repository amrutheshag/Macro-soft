...
public class MyOpenCasesListingAdd {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyOpenCasesAddTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing  Add My Open Cases ");
	try{
		 	    	...
		 	    	String details= ExcelUtils.getCellData(count,9);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running Add My Open cases- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running Add My Open Cases- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
...
public  void addMyOpenCasesMultiple(WebDriver driver, String subject, String type,  String status, String priority, String followUpDate, String noteType, String medium, String details) throws Exception {
		...
		myOpenCasesPageObject.addMyOpenCases(subject,  type,  status, priority, followUpDate, noteType, medium, details);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My Open Cases- Add");

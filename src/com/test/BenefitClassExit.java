...
public class BenefitClassExit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void BenefitClassExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Benefit Class- Exit");
			Log.info("Executing  Benefit Class- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Benefit Class Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Class Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitBenefitClassMultiple(driver,benefitClassCode);
		    		}
		    	}
			...
			public void exitBenefitClassMultiple(WebDriver driver,String benefitClassCode) throws Exception
			{
			...
			benefitClassPageObject.exitBenefitClass( benefitClassCode);
		...
		System.out.println("Done with Benefit Class-Exit  \n\n");
		Log.info("Done with Benefit Class-Exit  \n\n");
		if (fis != null)
				fis.close();

...
public class MembersExitMember {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void memberExitTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Members- Exit Member  ");
	try{
		String Path=Constant.Path_TestData + Constant.File_TestDataToAdd_Members;
		 	    	...
		 	    	for (int count=1; count<=rowCount; count++){
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running Members- Exit Members- Exit Members- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running Members- Exit Members- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		exitMultipleMembers(driver, mid, mlname, mdob, ssn);
...
public  void exitMultipleMembers(WebDriver driver, String mid, String mlname, String mdob, String ssn) throws Exception {
		...
		membersPageObject.exitMember( mid, mlname, mdob, ssn);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Members- Exit Member");

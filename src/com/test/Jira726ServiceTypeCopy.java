...
public class Jira726ServiceTypeCopy {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void Jira726ClaimTypeCopyTestScript() throws Exception{
			...
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing BenefitPlan Edit Service Type- Copy");
			Log.info("Executing  Benefit Plan Edit -Service Type Copy ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println(
		   		 			"Benefit Plan- Service Type Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Benefit Plan Edit- Service Type Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	editBenefitPlanCopyServiceTypeMultiple(driver,benefitPlanCode, benefitPlanName, benefitPlanPayer, newBenefitPlanCode, newBenefitPlanName, newBenefitPlanPayer, newClaimTypeQuery, newServiceTypeQuery, premiumStartDate, visionPremium, CoverageExtend, newNotes);
		    		}
		    	}
			...
			benefitPlanPageObject.editBenefitPlanCopyServiceType( benefitPlanCode, benefitPlanName, benefitPlanPayer, newBenefitPlanCode, newBenefitPlanName, newBenefitPlanPayer, newClaimTypeQuery, newServiceTypeQuery, premiumStartDate, visionPremium, CoverageExtend, newNotes);

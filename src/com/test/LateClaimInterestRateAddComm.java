...
public class LateClaimInterestRateAddComm {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void LateClaimsInterestRatesAddCommTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Late Claims Interest Rates- add comm");
			Log.info("Executing  Late Claims Interest Rates add comm ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Late Claims Interest Rates Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Late Claims Interest Rates Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	addCommInterestRatesMultiple(driver,effectiveDate, state, benefitProduct, subject, notetype,notesDetails);
		    		}
		    	}
			...
			public void addCommInterestRatesMultiple(WebDriver driver,String effectiveDate, String state, String benefitProduct, String subject, String noteType, String notesDetails) throws Exception
			{
			...
			claimInterestObject.InterestRateAddComm( effectiveDate, state, benefitProduct, subject, noteType, notesDetails);
		...
		System.out.println("Done with Late Claim Interest Rates-add comm \n\n");
		if (fis != null)
				fis.close();
	}
}

...
public class JournalContactMediasExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void journalcontactMediasExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Journal Contact Medias- Exit");
			Log.info("Executing  Journal Contact Medias- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Journal Contact Medias Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Journal Contact Medias Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitjournalcontactMediasMultiple(driver,journalcontactMediasCode);
		    		}
		    	}
			...
			public void exitjournalcontactMediasMultiple(WebDriver driver,String journalcontactMediasCode) throws Exception
			{
			...
			journalcontactMediasPageObject.exitJournalContactMedias(journalcontactMediasCode);
			 ...
			 @AfterMethod
	      		...
	      		System.out.println("Done with Journal Contact Medias-Exit \n\n");
	      		Log.info("log4j -Done with Journal Contact Medias-Exit \n\n");
	      		if (fis != null)
	      				fis.close();
	      	}
	      }

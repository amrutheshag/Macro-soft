...
public class JournalNoteTypesAddTestScript {
	WebDriver driver;
    FileInputStream fis;
                    @Test
                    public void JournalNoteTypesAddTestScriptTestScript() throws Exception{
                                    DOMConfigurator.configure("log4j.xml");
                                    System.out.println("\n*****************************************************\n");
                                    Log.info("\n*****************************************************\n");
                                    System.out.println("Executing Journal Note Types- Add");
                                    Log.info("Executing  Journal Note Types- Add ");
                                    ...
                                    for (int count=1; count<=rowCount; count++){
                                                    ...
                                                    System.out.println("\n----------------------------------------------------\n");
                                                                    System.out.println("Journal Note Types Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                    System.out.println("\n----------------------------------------------------\n");
                                                                    Log.info("----------------------------------------------------");
                                                                    Log.info("Journal Note Types Add- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                    Log.info("----------------------------------------------------");
                                                                    addJournalNoteTypesMultiple(driver,journalnoteTypesCode, journalnoteTypesName);
                                                    }
                                    }
                                    ...
                                    public void addJournalNoteTypesMultiple(WebDriver driver,String JournalNoteTypesCode, String JournalNoteTypesName) throws Exception
                                    {
                                    ...
                                    JournalNoteTypesObject.addJournalNoteTypes(JournalNoteTypesCode, JournalNoteTypesName);
                                    
                                    }
                                    @AfterMethod
                    	      		public void afterMethod() throws Exception {
                    	      		if (driver!=null) driver.quit();
                    	      		System.out.println("Done with Journal Note Types-Add \n\n");
                    	      		Log.info("log4j -Done with Journal Note Types-Add \n\n");
                    	      		if (fis != null)
                    	      				fis.close();
                    	      	}
                    	      }

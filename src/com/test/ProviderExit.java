...
public class ProviderExit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void providerExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Providers- Exit Providers");
			Log.info("Executing Providers- Exit Providers");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Provider Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Provider Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitProviderMultiple(driver, pLastname,  pCode,  pNPI,  pTAXid,  pCity,  pState,  pZIP,  pSpeciality);
		    		}
		    	}
			...
			public void exitProviderMultiple(WebDriver driver, String pLastname, String pCode, String pNPI, String pTaxID, String pCity, String pState, String pZip, String pSpeciality) throws Exception
			{
			...
			providerListingPageObject.exitProvider( pLastname,  pCode,  pNPI,  pTaxID,  pCity,  pState,  pZip,  pSpeciality);
		...
		System.out.println("Done with Providers-Exit Providers \n\n");
		if (fis != null)
				fis.close();
	}
}

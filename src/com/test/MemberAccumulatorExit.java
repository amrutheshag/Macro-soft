...
public class MemberAccumulatorExit {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MemberAccumulatorExitTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing Member Accumulators- Exit Accumulator ");
	try{
			...
			int rowCount=ExcelUtils.setExcelFile(Path, "Sheet1");
		 	...
		 	String  details = ExcelUtils.getCellData(count,13);
		 	   		...
		 	   		System.out.println("----------------------------------------------------");
		   		 	System.out.println("Running Member Accumulators -Exit Accum- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("----------------------------------------------------");
	 	    		
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Running Member Accumulaotrs -Exit Accum- Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
		 	   		memberAccumulatorExitMultiple(driver, mid, mlname, mfname, mdob, mssn,deniedClaimNo, deniedServiceFromDate, deniedServiceToDate);
...
public void memberAccumulatorExitMultiple(WebDriver driver, String mid, String mlname, String mfname, String mdob, String mssn, String deniedClaimNo, String deniedServiceFromDate, String deniedServiceToDate) throws Exception {
		...
		memberAccumulatorListingPageObject.memberAccumulatorExit(mid, mlname, mfname, mdob, mssn,deniedClaimNo, deniedServiceFromDate, deniedServiceToDate);
	...
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with Member Accumulators- Exit Accumulator");

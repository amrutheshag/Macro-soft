...
public class TierCopayScheduleExit {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void TierCopayScheduleExitTestScript() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing Tier Copay Schedule- Exit");
			Log.info("Executing  Tier Copay Schedule- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("Tier Copay Schedule Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("Tier Copay Schedule Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitTierCopayScheduleMultiple(driver,tierCopayName);
		    		}
		    	}
			...
			public void exitTierCopayScheduleMultiple(WebDriver driver,String tierCopayName) throws Exception
			{
			...
			tierCopaySchedulePageObject.exitTierCopaySchedule( tierCopayName);
		...
		System.out.println("Done with Tier Copay Schedule-Exit  \n\n");
		if (fis != null)
				fis.close();
		}
}

...
public class NorthAmericanIndustrialClassificationsExitTestScript {
	WebDriver driver;
	FileInputStream fis;
		@Test
		public void NorthAmericanIndustrialClassificationsExitTestScript1() throws Exception{
			DOMConfigurator.configure("log4j.xml");
			System.out.println("\n*****************************************************\n");
			Log.info("\n*****************************************************\n");
			System.out.println("Executing North American Industrial Classifications- Exit");
			Log.info("Executing  North American Industrial Classifications- Exit ");
			...
			try{
		    	...
		    	for (int count=1; count<=rowCount; count++){
		    		...
		    		System.out.println("\n----------------------------------------------------\n");
		   		 	System.out.println("North American Industrial Classifications Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	System.out.println("\n----------------------------------------------------\n");
		   		 	Log.info("----------------------------------------------------");
		   		 	Log.info("North American Industrial Classifications Exit- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
		   		 	Log.info("----------------------------------------------------");
   		 	exitNorthAmericanIndustrialClassificationsMultiple(driver,northamericanindustrialClassificationsCode);
		    		}
		    	}
			...
			public void exitNorthAmericanIndustrialClassificationsMultiple(WebDriver driver,String northamericanindustrialClassificationsCode) throws Exception
			{
			...
			northamericanindustrialClassificationsPageObject.exitNorthAmericanIndustrialClassifications( northamericanindustrialClassificationsCode);
		...
		System.out.println("Done with North American Industrial Classifications-Exit  \n\n");
		if (fis != null)
				fis.close();
	}
}

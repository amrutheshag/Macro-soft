...
public class JournalNoteTypesCopyTestScript {
	 WebDriver driver;
     FileInputStream fis;
                     @Test
                     public void JournalNoteTypesCopyTestScript1() throws Exception{
                                     DOMConfigurator.configure("log4j.xml");
                                     System.out.println("\n*****************************************************\n");
                                     Log.info("\n*****************************************************\n");
                                     System.out.println("Executing Journal Note Types- Copy");
                                     Log.info("Executing  Journal Note Types- Copy ");
                                     ...
                                     for (int count=1; count<=rowCount; count++){
                                                     ...
                                                     System.out.println("\n----------------------------------------------------\n");
                                                                     System.out.println("Journal Note Types Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                     System.out.println("\n----------------------------------------------------\n");
                                                                     Log.info("----------------------------------------------------");
                                                                     Log.info("Journal Note Types Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                     Log.info("----------------------------------------------------");
                                     copyJournalNoteTypesMultiple(driver,journalnoteTypesCode, journalnoteTypesNewCode, journalnoteTypesNewDescription);
                                                     }
                                     }
                                     ...
                                     public void copyJournalNoteTypesMultiple(WebDriver driver,String journalnoteTypesCode, String journalnoteTypesNewCode, String journalnoteTypesNewDescription) throws Exception
                                     {
                                     ...
                                     journalnoteTypesPageObject.copyJournalNoteTypes(journalnoteTypesCode, journalnoteTypesNewCode, journalnoteTypesNewDescription);
                                     ...
                                     @AfterMethod
                     	      		...
                     	      		System.out.println("Done with Journal Note Types-Copy \n\n");
                     	      		Log.info("log4j -Done with Journal Note Types-Copy \n\n");
                     	      		if (fis != null) 
                     	      				fis.close();
                     	      	}
                     	      }

...
public class PayerTypesCopyTestScript {
	 WebDriver driver;
     FileInputStream fis;
                     @Test
                     public void PayerTypesCopyTestScript1() throws Exception{
                                     DOMConfigurator.configure("log4j.xml");
                                     System.out.println("\n*****************************************************\n");
                                     Log.info("\n*****************************************************\n");
                                     System.out.println("Executing Payer Types- Copy");
                                     Log.info("Executing  Payer Types- Copy ");
                                     ...
                                     try{
                                                     ...
                                                     System.out.println("\n----------------------------------------------------\n");
                                                                     System.out.println("Payer Types Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                     System.out.println("\n----------------------------------------------------\n");
                                                                     Log.info("----------------------------------------------------");
                                                                     Log.info("Payer Types Copy- Running Iteration No:  " + ExcelUtils.getCellData(count,0));
                                                                     Log.info("----------------------------------------------------");
                                     copyPayerTypesMultiple(driver,payerTypesCode, payerTypesNewCode, payerTypesNewDescription);
                                                     }
                                     }
                                     ...
                                     public void copyPayerTypesMultiple(WebDriver driver,String payerTypesCode, String payerTypesNewCode, String payerTypesNewDescription) throws Exception
                                     {
                                     ...
                                     payerTypesPageObject.copyPayerTypes( payerTypesCode, payerTypesNewCode, payerTypesNewDescription);
                                     ...
                                     @AfterMethod
	                              		...
	                              		System.out.println("Done with Payer Types-Copy \n\n");
	                              		Log.info("Done with Payer Types-Copy \n\n");

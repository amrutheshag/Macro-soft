...
public class MyCaseHistoryEdit {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyCaseHistoryEditTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing  Edit My case history ");
	try{
		 	    	...
		 	    	String newFollowUpDate = ExcelUtils.getCellData(count,10);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running Edit My case history- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running Edit My Case History- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		editMyCaseHistoryMultiple(driver,subject,  followUpDate, newFollowUpDate);
...
public  void editMyCaseHistoryMultiple(WebDriver driver, String subject, String followUpDate,String newFollowUpDate) throws Exception {
		...
		myCaseHistoryPageObject.editMyCaseHistory(subject,  followUpDate, newFollowUpDate);

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My case history- edit");

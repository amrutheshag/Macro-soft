...
public class MyOpenCasesForFollowUpExit {
	FileInputStream fis;
	WebDriver driver;
	@Test
	public  void MyOpenCasesForFollowupExitTestScript () throws Exception{
		
		DOMConfigurator.configure("log4j.xml");
		System.out.println("\n********************************************************************");
		System.out.println("Executing  Exit My Open Cases For Followup ");
	try{
		 	    	...
		 	    	DateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy ");
		 	    	 ...
		 	    	 String followUpDate= dateFormat.format(fdate);
		 	   		...
		 	   		System.out.println("-------------------------------------------------------------");
		 	   		System.out.println("Running Exit My Open cases Followup- Iteration No: " + ExcelUtils.getCellData(count,0));
		 	   		System.out.println("-------------------------------------------------------------");
		 	   
		 	   	Log.info("----------------------------------------------------");
	   		 	Log.info("Running Exit My Open Cases for Followup- Iteration No:  " + ExcelUtils.getCellData(count,0));
	   		 	Log.info("----------------------------------------------------");
		 	   		
		 	   		
		 	   		
		 	   		exitMyOpenCasesForFollowupMultiple(driver);
...
public  void exitMyOpenCasesForFollowupMultiple(WebDriver driver) throws Exception {
		...
		myOpenCasesPageObject.exitMyOpenCasesForFollowUp();

}
		  
	@AfterMethod
	  public void afterMethod() throws Exception {
	    System.out.println("Done with My Open Cases for followup- Exit");
